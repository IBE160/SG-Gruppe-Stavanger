...
- Check citations include section names, not just file paths → Vague citations: PASS (No vague citations found)
...
- Testing subtasks < ac_count (4 < 3) → PASS (4 is not less than 3)
