            ...
            <div className="space-y-6">
              ...
              <div className="pt-6 border-t border-gray-200 space-y-4">
                <div className="flex gap-4">
                  <Link
                    href="/pantry"
                    className="inline-block px-6 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                  >
                    My Pantry
                  </Link>
                  <Link
